...
public class SubscriberDetailStepDefinition {
    ...
    public void que_el_abonado_consulta_saldos_sd() throws Throwable {
    ...
    @When("^el estado del abonado este dentro de los valores parametrizados SD$")
    public void el_estado_del_abonado_este_dentro_de_los_valores_parametrizados_sd() throws Throwable {
        System.out.println("2.2 el estado del abonado este dentro de los valores parametrizados SD$");
    }
    ...
    public void el_estado_del_abonado_no_este_dentro_de_los_valores_parametrizados_sd() throws Throwable {
