...
# Enviar parámetros desde gherkyn: para definir elementos, decir donde está definido el servicio (url) ok
# Enviar parámetros del request ok

# | var1 | var2 | var3 | 
# | abc  | cde  | fgh  |

# El parámetro se envía al request desde gherkyns y luego enviar que tag evaluar también desde gherkyns. ok
...
# Jmeter: archivo propiedades, apuntamiento
